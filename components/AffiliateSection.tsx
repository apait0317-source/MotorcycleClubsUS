...
const defaultProducts: AffiliateProduct[] = [
  {
    ...
    price: '$599.99',
    amazonAsin: 'B0D4P2HTX5',
    category: 'Helmets',
  },
  {
    name: 'Alpinestars GP Plus R V4 Jacket',
    description: 'CE-certified protection with premium leather construction',
    price: '$549.95',
    amazonAsin: 'B0CZ4K7ZDQ',
    category: 'Jackets',
  },
  {
    name: 'Alpinestars SP-8 V3 Gloves',
    description: 'Full-grain leather with dual-density knuckle protection',
    price: '$129.95',
    amazonAsin: 'B0B96HSHJ2',
    category: 'Gloves',
  },
  {
    name: 'Sena 50S Bluetooth Dual',
    description: 'Mesh 2.0 intercom with Harman Kardon speakers',
    price: '$499.00',
    amazonAsin: 'B09NXCLRMR',
